                    ...
                    <tr>
                        ...
                        <th
                            ...
                            <div
                                ...
                                <span class="dashicons dashicons-arrow-up" v-show="currentSortColumn === column" v-if="!isAsc"></span>
                                <span class="dashicons dashicons-arrow-down" v-show="currentSortColumn === column" v-else></span>
                        ...
                        <tr
                            ...
                            <td v-if="detailed">
                                <a role="button" @click.stop="toggleDetails(row)">
                                    <span class="dashicons dashicons-arrow-down" v-if="isVisibleDetailRow(row)"></span>
                                    <span class="dashicons dashicons-arrow-right" v-else></span>
                                </a>
                            </td>

                            <td class="checkbox-cell" v-if="checkable">
                                <input type="checkbox" :value="isRowChecked(row)" :checked="isRowChecked(row)" @click="checkRow(row)">
                            </td>
...
<script>
    import { getValueByPath, indexOf } from '../../utils/assist'
