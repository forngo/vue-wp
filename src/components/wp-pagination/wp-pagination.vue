<template>
    <div class="wp-pagination" :class="[order, size, { 'is-simple': simple }]">
        <ul class="wp-pagination-list">
            <li>
                <a
                    role="button"
                    href="#"
                    class="wp-pagination-previous"
                    :disabled="!hasPrev"
                    @click.prevent="prev" >
                    Prev
                </a>
        ...
        <ul class="wp-pagination-list" v-if="!simple">
            <!--First-->
            <li v-if="hasFirst">
                <a
                    role="button"
                    href="#"
                    class="wp-pagination-link"
                    @click.prevent="first">
                    1
                </a>
            </li>
            <li v-if="hasFirstEllipsis"><span class="wp-pagination-ellipsis">&hellip;</span></li>
            ...
            <!--Last-->
            <li v-if="hasLastEllipsis"><span class="wp-pagination-ellipsis">&hellip;</span></li>
            <li v-if="hasLast">
                <a
                    role="button"
                    href="#"
